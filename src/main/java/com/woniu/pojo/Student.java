...
public class Student implements java.io.Serializable {
	...
	public Student(int stuid, String idcard) {
		this.stuid = stuid;
		this.idcard = idcard;
	}

	public Student(int stuid, Checkrecord checkrecord, Classes classes, Examrecord examrecord, Headmaster headmaster,
			Stage stage, Teacher teacher, String stuname, String sex, String idcard, Date intime, String phone,
			String address, Date edutime, String school, String domain, Set examrecords, Set checkrecords) {
		this.stuid = stuid;
